...
namespace NetworkTools.Tests.PathTransform {
    ...
    public class ShapeCalculatorTests {
        ...
        public void CalculatePositionLinear_AtStart_ReturnsStartXZ() {
            var result = ShapeCalculator.CalculatePositionLinear(0f,
                100f,
                new float2(0f,   0f),
        ...
        public void CalculatePositionLinear_AtEnd_ReturnsEndXZ() {
            var result = ShapeCalculator.CalculatePositionLinear(100f,
                100f,
                new float2(0f,   0f),
                new float2(100f, 100f));
        ...
        public void CalculatePositionLinear_AtMidpoint_ReturnsInterpolated() {
            var result = ShapeCalculator.CalculatePositionLinear(50f,
                100f,
                new float2(0f,   0f),
                new float2(100f, 100f));
        ...
        public void CalculatePositionLinear_ClampsBeyondEnd() {
            var result = ShapeCalculator.CalculatePositionLinear(150f, // Beyond total length
                100f,
                new float2(0f,   0f),
                new float2(100f, 100f));
        ...
        public void CalculateControlPointRatios_StraightLine_Forward() {
            ...
            ShapeCalculator.CalculateControlPointRatios(bezier,
                100f,
                true,
                out var ctrlStartRatio,
                out var ctrlEndRatio);
        ...
        public void CalculateStraightenedPositions_AllPointsOnLine() {
            var positions = ShapeCalculator.CalculateStraightenedPositions(0f,
                100f,
                1f / 3f,
                2f / 3f,
                100f,
        ...
        public void CalculateStraightenedPositions_MidPath_CorrectOffset() {
            ...
            var positions = ShapeCalculator.CalculateStraightenedPositions(50f,
                50f,
                1f / 3f,
                2f / 3f,
                100f,
        ...
        public void ApplyPositionsToBezier_Forward_CorrectAssignment() {
            ...
            var result = ShapeCalculator.ApplyPositionsToBezier(bezier, positions, true);
        ...
        public void EvaluateBezier_AtT0_ReturnsP0() {
            ...
            var p1 = new float2(10f, 20f);
            var p2 = new float2(30f, 40f);
            var p3 = new float2(50f, 50f);

            var result = ShapeCalculator.EvaluateBezier(p0, p1, p2, p3, 0f);
        ...
        public void EvaluateBezier_AtT1_ReturnsP3() {
            ...
            var result = ShapeCalculator.EvaluateBezier(p0, p1, p2, p3, 1f);
        ...
        public void EvaluateBezier_StraightLine_ReturnsLinearInterpolation() {
            ...
            var p0 = new float2(0f,   0f);
            var p1 = new float2(25f,  25f);
            var p2 = new float2(75f,  75f);
            var p3 = new float2(100f, 100f);

            var result = ShapeCalculator.EvaluateBezier(p0, p1, p2, p3, 0.5f);
        ...
        public void EvaluateBezierTangent_AtT0_PointsToP1() {
            ...
            var p2 = new float2(20f, 0f);
            var p3 = new float2(30f, 0f);

            var tangent = ShapeCalculator.EvaluateBezierTangent(p0, p1, p2, p3, 0f);
        ...
        public void EvaluateBezierTangent_AtT1_PointsFromP2() {
            ...
            var tangent = ShapeCalculator.EvaluateBezierTangent(p0, p1, p2, p3, 1f);
        ...
        public void GetBezierTangentXZ_Forward_Start_ReturnsAtoB() {
            ...
            var tangent = ShapeCalculator.GetBezierTangentXZ(bezier, true, true);
        ...
        public void GetBezierTangentXZ_Forward_End_ReturnsCtoD() {
            ...
            var tangent = ShapeCalculator.GetBezierTangentXZ(bezier, false, true);
        ...
        public void GetBezierTangentXZ_Reversed_Start_ReturnsDtoC() {
            ...
            var tangent = ShapeCalculator.GetBezierTangentXZ(bezier, true, false);
        ...
        public void CalculateMasterBezierControls_SymmetricPath_SymmetricControls() {
            var startXZ = new float2(0f,      0f);
            var endXZ = new float2(100f,      0f);
            var startTangent = new float2(1f, 0f); // Pointing right
            var endTangent = new float2(1f,   0f); // Pointing right

            ShapeCalculator.CalculateMasterBezierControls(startXZ,
                endXZ,
                startTangent,
                endTangent,
                100f,
        ...
        public void CalculateMasterBezierControls_AngledPath_CorrectControls() {
            var startXZ = new float2(0f,      0f);
            var endXZ = new float2(100f,      100f);
            var startTangent = new float2(1f, 0f); // Pointing right
            var endTangent = new float2(0f,   1f); // Pointing up
