    ...
    public partial class NT_OverlayRenderSystem {
        ...
        protected struct DrawHandlesJob : IJobChunk {
            ...
            public void Execute(in ArchetypeChunk chunk,
                ...
                for (var i = 0; i < entitiesArray.Length; i++) {
                    ...
                    if (handle.HasAnyFlag(HandleTypeFlags.Line) && hasLineComponent) {
                        ...
                        if (m_NodeLookup.HasComponent(link.LinkedEntity) && m_CurveLookup.HasComponent(link.LinkedEdge)) {
                            ...
                            RenderBezierPointHandle(curve, position, handle, link, isControlPoint, isHighlighted, isSelected, m_Buffer);
                        }
                    } else {
            ...
            private static void RenderBezierPointHandle(Curve curve, NT_HandlePosition position, NT_Handle handle,
                NT_HandleLink link, bool isControlPoint, bool isHighlighted, bool isSelected,
